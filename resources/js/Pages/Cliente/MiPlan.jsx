        ...
        <ClienteLayout user={user}>
            ...
            <div style={{ maxWidth: 800, margin: '0 auto' }}>
                ...
                <div style={{ marginBottom: '2rem' }}>
                    <h1 style={{ fontSize: '2rem', fontWeight: 900, color: C, margin: '0 0 0.25rem', textShadow: '0 0 10px rgba(255,20,147,0.5)' }}>💳 Mi Plan</h1>
                ...
                {planActivo ? (
                    ...
                    <div style={{ background: 'rgba(10,10,10,0.95)', border: '2px solid rgba(255,20,147,0.2)', borderRadius: 16, padding: '3rem', textAlign: 'center', marginBottom: '2rem' }}>
                        <p style={{ color: '#666', fontSize: '1.1rem', margin: '0 0 0.5rem' }}>💳 No tienes un plan activo</p>
