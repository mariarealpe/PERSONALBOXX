    ...
    return (
        <div className="dashboard-container">
            ...
            <div className="main-content">
                <header className="header">
                    ...
                    <div className="header-user">
                        ...
                        <Link href="/logout" method="post" as="button" className="logout-button">Cerrar Sesión</Link>
                    </div>
                </header>
            ...
            <style>{`
                ...
                .sidebar-header { padding: 2rem 1.5rem; border-bottom: 1px solid rgba(255,20,147,0.2); }
                .logo { display: flex; align-items: center; gap: 1rem; }
                .logo-icon { width: 40px; height: 40px; color: #FF1493; filter: drop-shadow(0 0 10px #FF1493); }
                ...
                .nav-item { display: flex; align-items: center; gap: 1rem; padding: 1rem 1.5rem; color: #999; text-decoration: none; transition: all 0.3s; border-left: 3px solid transparent; font-weight: 600; }
                ...
                .sidebar-footer { padding: 1.5rem; border-top: 1px solid rgba(255,20,147,0.2); }
                .profile-info { display: flex; align-items: center; gap: 1rem; }
                .profile-avatar { width: 45px; height: 45px; border-radius: 50%; background: linear-gradient(135deg, #FF1493, #e60083); display: flex; align-items: center; justify-content: center; color: #fff; font-weight: 900; font-size: 1.25rem; box-shadow: 0 0 15px rgba(255,20,147,0.5); flex-shrink: 0; }
                .profile-text { overflow: hidden; }
                .profile-name { color: #FF1493; font-weight: 700; margin: 0; font-size: 0.875rem; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
                .profile-email { color: #666; margin: 0; font-size: 0.75rem; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
                .main-content { flex: 1; margin-left: 280px; display: flex; flex-direction: column; }
                .header { background: rgba(10,10,10,0.95); border-bottom: 2px solid #FF1493; padding: 1rem 2rem; display: flex; justify-content: space-between; align-items: center; box-shadow: 0 0 20px rgba(255,20,147,0.2); position: sticky; top: 0; z-index: 50; }
                ...
                .user-name { color: #FF1493; font-weight: 700; font-size: 0.875rem; }
                .logout-button { background: rgba(255,20,147,0.1); border: 1px solid #FF1493; color: #FF1493; padding: 0.5rem 1rem; border-radius: 6px; font-size: 0.875rem; font-weight: 600; cursor: pointer; transition: all 0.3s; }
                .logout-button:hover { background: #FF1493; color: #000; box-shadow: 0 0 15px rgba(255,20,147,0.5); }
