        ...
        <div className="dashboard-container">
            ...
            <aside className={`sidebar ${sidebarOpen ? 'open' : ''}`}>
                ...
                <div className="sidebar-header">
                    <Link href="/instructor/clases" className="logo logo-link" onClick={() => setSidebarOpen(false)}>
                ...
                <nav className="sidebar-nav">
                    <Link href="/dashboard" className={`nav-item ${isActive('/dashboard') && !isActive('/instructor') ? 'active' : ''}`} onClick={() => setSidebarOpen(false)}>
                        <span className="nav-icon">{icons.dashboard}</span><span>Dashboard</span>
                    </Link>
                    <Link href="/instructor/clases" className={`nav-item ${isActive('/instructor/clases') ? 'active' : ''}`} onClick={() => setSidebarOpen(false)}>
                        <span className="nav-icon">{icons.calendar}</span><span>Mis Clases</span>
                    </Link>
                    <Link href="/instructor/asistencias" className={`nav-item ${isActive('/instructor/asistencias') ? 'active' : ''}`} onClick={() => setSidebarOpen(false)}>
                        <span className="nav-icon">{icons.check}</span><span>Asistencias</span>
                    </Link>
                    <Link href="/instructor/liquidacion" className={`nav-item ${isActive('/instructor/liquidacion') ? 'active' : ''}`} onClick={() => setSidebarOpen(false)}>
                        <span className="nav-icon">{icons.chart}</span><span>Mi Liquidación</span>
                    </Link>
                </nav>
            ...
            <div className="main-content">
                <header className="header" style={{ isolation: 'isolate' }}>
                    ...
                    <Link href="/instructor/clases" className="header-home-link" onClick={() => setSidebarOpen(false)}>
                        <span className="header-home-icon">{icons.heart}</span>
                        <span className="header-home-text">Instructor</span>
                    </Link>
